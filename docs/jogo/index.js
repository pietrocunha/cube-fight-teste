...
//importando escolhas do jogador
...
class Jogador {
    ...
    desenhar() {
        if (this.orientacao == 'esquerda') {
            ...
            c.save();
            c.scale(-1, 1);
            c.drawImage(imgCaraBravo, -this.position.x - this.width, this.position.y, this.width, this.height); //desenhando rosto
            c.drawImage(imgchapeuMago, -this.position.x - imgchapeuMago.width + 5, this.position.y - imgchapeuMago.height + 5, imgchapeuMago.width, imgchapeuMago.height); //desenhando chapeu
            c.drawImage(imgroupaRei, -this.position.x - imgroupaRei.width + 2, this.position.y + this.height - imgroupaRei.height, imgroupaRei.width, imgroupaRei.height); //desenhando roupa
            c.restore();
        } else {
            // normal
            c.drawImage(imgCaraBravo, this.position.x, this.position.y, this.width, this.height); //desenhando rosto
            c.drawImage(imgchapeuMago, this.position.x - 5, this.position.y - imgchapeuMago.height + 5, imgchapeuMago.width, imgchapeuMago.height); //desenhando chapeu
            c.drawImage(imgroupaRei, this.position.x - 2, this.position.y + this.height - imgroupaRei.height, imgroupaRei.width, imgroupaRei.height); //desenhando roupa
...
console.log(imgPlataformaCentral.height)
console.log(imgPlataformaDireita.height)
console.log(imgPlataformaEsquerda.height)
